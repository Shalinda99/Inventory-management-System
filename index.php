...
<link rel="icon" href="./ACCOUNTABLES.png" type="image/gif">
  <body>
      <div class="login_con">
<?php
	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-search-tab" data-toggle="pill" href="#v-pills-search" role="tab" aria-controls="v-pills-search" aria-selected="false">Summary</a>
			  <a class="nav-link" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Products</a>
			  <a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false">Purchases</a>
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Suppliers</a>
					...
					<div class="tab-content">
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <button type="button" id="addItem" class="btn" style="background-color: #198754;color:white;">Add</button>
							  <button type="button" id="updateItemDetailsButton" class="btn" style="background-color: #005185;color:white;">Update</button>
							  <button type="button" id="deleteItem" class="btn" style="background-color: #DC3545;color:white;">Delete</button>
							  <button type="reset" id="itemClear" class="btn">Clear</button>
							</form>
						</div>
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2022-10-31">
						</div>
						<div class="form-group col-md-2">
					  ...
					  <div class="form-row"> 
						  ...
						  <div class="form-group col-md-2">
							  <label for="purchaseDetailsCurrentStock">Current Stock Level</label>
							  <input type="text" class="form-control" id="purchaseDetailsCurrentStock" name="purchaseDetailsCurrentStock" readonly>
						  </div>
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsVendorName">Suppliers Name<span class="requiredIcon">*</span></label>
					  ...
					  <button type="button" id="addPurchase" class="btn" style="background-color: #198754;color:white;">Add</button>
					  <button type="button" id="updatePurchaseDetailsButton" class="btn" style="background-color: #005185;color:white;">Update</button>
					  <button type="reset" class="btn">Clear</button>
					</form>
				  </div> 
				</div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <button type="button" id="addVendor" name="addVendor" class="btn" style="background-color: #198754;color:white;">Add</button>
					  <button type="button" id="updateVendorDetailsButton" class="btn" style="background-color: #005185;color:white;">Update</button>
					  <button type="button" id="deleteVendorButton" class="btn" style="background-color: #DC3545;color:white;">Delete</button>
					  <button type="reset" class="btn">Clear</button>
					 </form>
				  </div> 
				</div>
					...
					<form>
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-5">
							<label for="saleDetailsItemName">Product Name</label>
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="2022-10-31" name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
					  ...
					  <button type="button" id="addSaleButton" class="btn" style="background-color: #198754;color:white;">Add</button>
					  <button type="button" id="updateSaleDetailsButton" class="btn" style="background-color: #005185;color:white;">Update</button>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <button type="button" id="addCustomer" name="addCustomer" class="btn" style="background-color: #198754;color:white;">Add</button>
					  <button type="button" id="updateCustomerDetailsButton" class="btn" style="background-color: #005185;color:white;">Update</button>
					  <button type="button" id="deleteCustomerButton" class="btn" style="background-color: #DC3545;color:white;">Delete</button>
					  <button type="reset" class="btn">Clear</button>
					 </form>
				  </div> 
				</div>
			  ...
			  <div class="tab-pane fade show active" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemSearchTab">Products</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#purchaseSearchTab">Purchases</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#vendorSearchTab">Suppliers</a>
						</li>
						<li class="nav-item">
